...
4. Frame methods expose reusable spatial analysis primitives such as nearest neighbors, map-window queries, reprojection, spatial joins, dissolve, clip operations, overlay intersections, interaction tables, area similarity tables, and corridor accessibility.
...
- `frame.py` wraps point records with geometry-aware methods, CRS state, join logic, and dissolve behavior.
