...
- `frame.py` wraps point records with geometry-aware methods, CRS state, nearest and proximity join logic, predicate joins, service-area helpers, nearest-assignment workflows, and dissolve behavior.
