...
- The real standalone widget checkout now lives at `standalone-checkouts/experience-builder-station-brief-widget`; the older `standalone-repos/experience-builder-station-brief-widget` folder is now legacy-only and no longer part of the recommended workflow.
