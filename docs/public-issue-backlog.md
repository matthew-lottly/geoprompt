...
- The real standalone widget checkout now lives at `standalone-checkouts/experience-builder-station-brief-widget`, which is the current recommended workflow for standalone repository maintenance.
