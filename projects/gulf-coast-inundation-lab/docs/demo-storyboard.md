...
2. Open [assets/gauge-validation-footprint-live.png](assets/gauge-validation-footprint-live.png) to show the spatial validation footprint at a glance.
...
7. Run the local validation CLI and open `outputs/gulf_coast_validation_summary.json` plus `outputs/charts/gauge-validation-footprint.png` and `outputs/charts/gauge-validation-ranking.png` to show both the spatial footprint and the article-style $R^2$ summary.
